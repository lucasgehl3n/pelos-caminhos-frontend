    ...
    <template v-if="!route.path.includes('login')">
      ...
      <div v-else-if="$device.isDesktop">
        <div class="flex h-screen">
          ...
          <div id="sidebar-double"
            class="flex z-40 top-0 left-0 h-full transition-transform -translate-x-full sm:translate-x-0"
            aria-label="Sidebar">
            <div
              class="overflow-y-auto z-30 py-5 px-3 w-16 h-full bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700">
              <ul class="space-y-2">
                <li>
                  <a href="#"
