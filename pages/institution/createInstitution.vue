  ...
  <div class="w-full sm:w-3/5">
    ...
    <div v-if="isStepInitialSelected">
      ...
      <div>
        <label
          for="message"
          class="block mb-2 text-sm font-medium text-gray-900 dark:text-white my-10"
        >
          {{ $t("how_volunteers_can_help") }}
        </label>
        <div id="quillHowVolunteersCanHelp">
          <perfect-scrollbar class="scrollable w-full psBadges">
            <quill-editor
              theme="snow"
              name="howVolunteersCanHelp"
              v-model:content="form.howVolunteersCanHelp"
              contentType="html"
              v-on:change="removeFieldError"
            ></quill-editor>
          </perfect-scrollbar>
