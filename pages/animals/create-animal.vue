  ...
  <div v-show="isLoaded">
    <div v-show="isStepInitialSelected" class="sm:flex">
      <div class="w-full sm:w-4/12">
        <div>
          <div class="pt-2 pb-5">
            ...
            <Multiselect
              v-model="form.idInstitution"
              :options="listInstitutions"
              :disabled="!showFieldInstitution"
              valueProp="id"
              :multiple="false"
              label="name"
            >
        ...
        <div>
          <Input
            :placeholder="$t('leave_it_blank_if_dont_have')"
            v-model="form.name"
            :label="$t('name')"
            name="name"
        ...
        <div class="pt-2 w-full sm:w-6/12">
          <div class="pt-2 w-full">
            <label
              class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300 w-full"
            >
              {{ $t("species") }}
            </label>
      ...
      <div class="w-full sm:w-4/12 sm:pl-10">
        ...
        <div class="pt-2">
          <Input
            :placeholder="$t('collection_place')"
            v-model="form.collectionPlace"
            :label="$t('collection_place')"
      ...
      <div class="flex w-full">
        <div class="w-full sm:w-6/12">
          ...
          <div class="py-2">
            ...
            <Multiselect
              v-if="behavioralProfileList && behavioralProfileList.length > 0"
              v-model="form.idBehavioralProfile"
              :options="behavioralProfileList"
              valueProp="id"
              :multiple="false"
              label="name"
            />
      ...
      <div class="block sm:flex w-full">
        <div class="w-full sm:w-6/12">
          ...
          <div v-if="form.idSituation === AnimalSituation.TemporaryHome">
            <temporaryHome
              :form="form"
              :formFieldErrorValidator="temporaryHomeErrorValidator"
              v-on:update-entity="updateTemporaryHome"
              v-on:updateForwardingDate="updateForwardingDate"
            >
            </temporaryHome>
          </div>
          ...
          <div v-else-if="form.idSituation === AnimalSituation.Adopted">
            <Adopted
              :form="form"
              :formFieldErrorValidator="adoptionErrorValidate"
              v-on:update-entity="updateAdoption"
          ...
          <div v-else-if="form.idSituation === AnimalSituation.Death">
            <Death
              :form="form"
              :formFieldErrorValidator="deathErrorValidator"
              v-on:update-entity="updateTemporaryHome"
        ...
        <div class="w-full md:pl-10 sm:w-6/12">
          <tabs variant="underline" v-model="currentVeterinaryTab" class="p-5">
            ...
            <tab name="second" title="Anexos" :disabled="false">
              <Files
                :form="form"
                v-on:update-entity="updateFiles"
    ...
    <div class="pt-32 sm:pt-0">
      <FloatButtons :primary-action="save" :secondary-action="() => {}"></FloatButtons>
    </div>
  </div>
</template>
