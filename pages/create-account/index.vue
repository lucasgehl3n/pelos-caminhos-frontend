...
import FieldValidatorForm, {
  FieldsToValidate,
  formFieldErrorValidator,
} from "./helpClasses/fieldValidatorForm";
...
const fieldValidatorForm = new FieldValidatorForm(
  fieldsToValidate,
  form,
...
<template>
  <section
    :style="{ backgroundImage: `url('${randomImageBg}')` }"
  ...
  >
    <perfect-scrollbar class="form-fields">
      <div class="flex flex-col items-start justify-center mx-auto pt:mt-0 h-full">
        <div
          class="w-full h-full bg-white shadow sm:max-w-screen-md sm:py-20 pt-10 px-10 dark:bg-gray-800"
        >
          <div class="w-full min-h-screen sm:h-full">
            ...
            <div v-show="isStepInitialSelected" class="h-full">
              <tabStart
                ...
                :fieldValidatorForm="fieldValidatorForm"
                :stepperControlValues="stepperControlValues"
              >
              </tabStart>
            </div>
